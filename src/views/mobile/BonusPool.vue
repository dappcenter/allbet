    ...
    <div class="content">
        ...
        <div class="part1" v-show="topBtnIndex == 0">
            <div class="progress-wrap">
                <h4 v-show="coinType == 'TRX'">{{$t("message.abStage2")}}（{{$t("message.BPmost")}} 100TRX : 45AB）</h4>
                <h4 v-show="coinType == 'ETH'">{{$t("message.abStage2")}}（{{$t("message.BPmost")}} 1ETH : 2250AB）</h4>
                <div class="progress-bar"><i>{{(progressDig).toFixed(2)}}/700,000,000</i><span :style="{'width': progressDig/700000000*100 + '%'}"></span></div>
                <h5 v-show="coinType == 'TRX'">{{$t("message.abStage3")}}（{{$t("message.BPmost")}} 100TRX : 40AB）</h5>
                <h5 v-show="coinType == 'ETH'">{{$t("message.abStage3")}}（{{$t("message.BPmost")}} 1ETH : 2000AB）</h5>
            </div>
            <div class="jackpot-wrap">
                ...
                <div class="coin-wrap eth">
                    <div class="coin-logo">
                        ...
                        <span v-if="new Date().getTime() < storeBonusPoolsData.profitTime*1">{{$t('message.BPtimeDown')}}<TimeCountDown :time="storeBonusPoolsData.profitTime*1"></TimeCountDown></span>
                    </div>
                    <div class="item-r">
                        <div class="cell-top">
...
export default {
  ...
  computed: {
    ...
    progressDig() {
        if(this.storeBonusPoolsData.progressDig > 1000000000) {
            return this.storeBonusPoolsData.progressDig-1000000000
        }else {
            return this.storeBonusPoolsData.progressDig
        }
    }
  },
  methods: {
