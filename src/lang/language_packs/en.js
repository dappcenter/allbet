...
export default {
    message: {
        ...
        InvitationRules2: "1.You can get a reward of 8% AB token which is mined by your friend when your friend joins in game mining, and your friend can also get a reward of 2% AB token.",
        InvitationRules3: "2.The reward above comes from the system airdrop.",
        InvitePeople: "People",
        ...
        BPmyBalance: "My BALANCE",
        BPtip3: "Total frozen",
        BPtip4: "Your frozen",
        BPtip5: "* 24 hours are needed for unfreeze.",
        BPmyErnings: "Available Dividends",
        BPtimeDown: "Countdown: ",
        BPyichiyou: "Withdrawn",
        BPyidongjie: "Frozen",
        BPfreeze: "Freeze",
        BPunfreeze: "Unfreeze",
        BPrepeal: "Cancel",
        ...
        BPtip6: "* 1. Please make sure your address is correct.<br />&nbsp; 2. Assets will be transferred instantly.<br />&nbsp; 3. As a financial security mechanism,  large withdrawals will be manually reviewed and be transferred within 2 hours.",
        ...
        BPIFStext3TRX: "3. Withdrawing AB may cost TRX ( between 0.5-0.8 TRX each time). We advise withdrawing only when it is nessary to avoid transaction costs.",
        BPIFStext3ETH: "3. Withdrawing AB may cost gas fee. We advise withdrawing only when it is nessary.",
        BPIFStext3EOS: "3. Withdrawing AB may cost resources. We advise withdrawing only when it is nessary.",
        BPIFStext4: "4.	Unfrozen AB will be transferred to your account within 24 hours based on the last time of unfrozen. Unfrozen AB cannot pay out dividends.",
        BPIFStext5: "5.	Tronscan doesn’t support smart contract transaction check because dividends are paid out automatically by smart contract. We will make sure dividends will be transferred instantly.",
        BPApplicationSubmitted: "Application submitted",
        BPalert1: "The quantity must be greater than 1",
        // 公告
