...
export default {
    message: {
        ...
        GameStage: "Stages of mining: The first round",
        ...
        abGet: 'The total amount of AB Token is 10 billion, which is issued on the TRON main network, EOS main network and the ETH main network, respectively, with a total of 3 billion, 4 billion and 3 billion. There is 50% AB token being released by mining. The mining has ten stages.',
