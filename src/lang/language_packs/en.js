...
export default {
    message: {
        ...
        GameKnow: "I know",
        GameHelp: "<p style='text-align: justify'>1.1. Make sure you have a account or MetaMask. For more information on how to install MetaMask, Please see the white paper.<br /><br />2. To play you must own ETH, New registered users enter WeChat group to get the reward of  0.1 ETH.<br /><br />3. Set your BET NUMBER. This is the amount of ETH you will be betting.<br /><br />4. You can adjust the slider to choose PREDICTION number you'd like to roll under. As you move the slider, your payout and win chance will adjust automatically.<br /><br />5. Click GUESS LESS THAN50 to place your bet. The smart contracts will then randomly generate a LUCKY number from 1~100.<br /><br />6. If the lucky number is less than your prediction then you WIN! <br /><br />7. Each bet placed will give you AB tokens, for more information check out our INFO.<br /><br />Still have questions? Join our WeChat group and we'll be more than happy to help!</p>",
