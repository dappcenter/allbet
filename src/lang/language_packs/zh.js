...
export default {
    message: {
        ...
        GameKnow: "我知道了",
        GameHelp: "现在骰子滚动有100种结果，结果限制在1-100。想要赢的话，骰子结果必须小于您选择的数字。如果骰子结果低于等于您的数字，您就赢了！例如，您移动滑块选择预测为70，那么出现的幸运数在1~69范围内，您都将赢取收益，收益等于下注金额乘以赔率。为避免玩家沉迷，理理性游戏，最大下注量量为平台ETH数量的1.5%，最小下注量量为0.01ETH。参与游戏会获得一定数额的AB币，⽤以领取平台分红。注意：如果获胜，则从返回给玩家的总金额中减去1％的佣金。您将需要支付小额gas费来下注。我们平台不接收gas费。gas费用于维持以太坊区块链。",
        GameHowToPlay: "怎么玩？",
        GameRule: "游戏规则",
