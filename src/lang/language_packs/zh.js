...
export default {
    message: {
        ...
        GameKnow: "我知道了",
        GameHelp: "<p style='text-align: justify'>1.确保您有一个平台账号或MetaMask插件。有关如何下载MetaMask插件，请查看白皮书。<br /><br />2.设置您的竞猜数量，也就是您要下注的ETH数量。<br /><br />3.您可以调整滑块选择想要的预测数。移动滑块时，您可赢得的总金额和胜率都将自动调整。想要赢的话可选择一个大的预测数。<br /><br />4.点击猜小于50按钮开始游戏。智能合约随后将从1-100之间随机生成一个幸运数字。<br /><br />5.如果幸运数字小于您的预测数，您就赢了！<br /><br />6.每次下注系统都会将挖矿所得AB返还到您的钱包，更多相关信息，请查看我们的白皮书。<br /><br />仍然还有疑问？欢迎加入我们的微信群，我们非常乐意为您提供帮助！</p>",
        GameHowToPlay: "怎么玩？",
        GameRule: "游戏规则",
